...
public class ResumeNaukriApply {
	...
	public void naukri(String search) throws Throwable {
		...
		driver.findElement(By.id("passwordField")).sendKeys("7022092705");
		driver.findElement(By.xpath("//button[.='Login']")).click();

		driver.findElement(By.xpath("//div[@class=\"btn btn-block btn-large white-text\"]")).click();
		// nithish anna genius
		File f = new File("./src/test/resources/manual+selenium+fresher.pdf");
		String absolute = f.getAbsolutePath();
		System.out.println(absolute);

		driver.findElement(
				By.xpath("//input[@class=\"fileUpload waves-effect waves-light btn-large\" and @id=\"attachCV\"]"))
				.sendKeys(absolute);
		Thread.sleep(5000);
		...
		List<WebElement> companies = driver
				.findElements(By.xpath("//a[contains(text(),'est') and @class='title ellipsis' ]"));
